...
import net.sourceforge.queried.gametypes.AAServerInfo;
import net.sourceforge.queried.gametypes.BF1942ServerInfo;
import net.sourceforge.queried.gametypes.BF2142ServerInfo;
import net.sourceforge.queried.gametypes.BF2ServerInfo;
import net.sourceforge.queried.gametypes.BFVServerInfo;
import net.sourceforge.queried.gametypes.D3ServerInfo;
import net.sourceforge.queried.gametypes.ETServerInfo;
import net.sourceforge.queried.gametypes.HLServerInfo;
import net.sourceforge.queried.gametypes.NEXServerInfo;
import net.sourceforge.queried.gametypes.NWNServerInfo;
import net.sourceforge.queried.gametypes.Q4ServerInfo;
import net.sourceforge.queried.gametypes.SOF2Q3ServerInfo;
import net.sourceforge.queried.gametypes.SourceServerInfo;
import net.sourceforge.queried.gametypes.UT2ServerInfo;
import net.sourceforge.queried.gametypes.UTServerInfo;
import net.sourceforge.queried.gametypes.WSWServerInfo;
...
//        supportedGames.put("BF2142", "Battlefield 2142");
  ...
  /**
   * Returns a HashMap of the games that QueriEd supports. The key is the game code. The full game name is the value.
   * 
   ...
   * <br/>
   * Ask for server details: name, ip, port, game, gameVersion, map, playerCount, maxPlayers. This will use the
   * specified local port to create the socket (useful if you need to configure your firewall)<br/>
   * <br/>
   * Valid game types:
   * <ul>
   ...
   * <li><b>COD4</b> - Call of Duty 4</li>
   * <li><b>D3</b> - Doom 3</li>
   * <li><b>ET</b> - Enemy Territory</li>
   * <li><b>ETQW</b> - Enemy Territory Quake Wars</li>
   ...
   * 
   * @param localPort
   *          a port on the machine that the bot is running from that will be used to make the query
   * @param gameType
   *          one of the supported game types, defaults to Halflife
   * @param ipStr
   *          the ip (numerical or hostname) of the server
   * @param port
   ...
   * Query a game server for server details.<br/>
   * <br/>
   * Ask for server details: name, ip, port, game, gameVersion, map, playerCount, maxPlayers. This will try to find an
   * open socket on the local machine.<br/>
   * <br/>
   * Valid game types:
   * <ul>
   * <li><b>AA</b> - Americas Army</li>
   ...
   * <br/>
   * Ask for player details: name, kills, deaths, score, objectives completed. This will use the specified local port to
   * create the socket (useful if you need to configure your firewall)<br/>
   * <br/>
   * Valid game types:
   * <ul>
   * <li><b>AA</b> - Americas Army</li>
   ...
   * @param port
   *          the query port of the server
   * @return an ArrayList of PlayerInfo objects, the list will be empty if there aren't any players on the server
   */
  public static List<PlayerInfo> playerQuery(int localPort, String gameType, String ipStr, int port) {
    int resolvedGameType = resolve(gameType);
   ...
   * Query a game server for player information.<br/>
   * <br/>
   * Ask for player details: name, kills, deaths, score, objectives completed. This will try to find an open socket on
   ...
   * @return an ArrayList of PlayerInfo objects, the list will be empty if there aren't any players on the server
   */
  public static List<PlayerInfo> playerQuery(String gameType, String ipStr, int port) {
  ...
  private static List<PlayerInfo> playerQuery(int localPort, int gameType, String ipStr, int port, int infoType) {
